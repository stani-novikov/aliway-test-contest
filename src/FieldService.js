...
var Influencer_1 = require("./models/Influencer");
var FieldService = /** @class */ (function () {
    function FieldService() {
        this.influencers = [
            new Influencer_1["default"]({
                id: '4118214092',
                name: 'dej_supes',
     ...
     */
    FieldService.prototype.getInfluencers = function () {
        var _this = this;
        return new Promise(function (resolve) {
            setTimeout(function () {
                var clonedInfluencers = _this.influencers.map(function (influencer) { return influencer; });
     ...
     */
    FieldService.prototype.getInfluencerSync = function (influencerId) {
        if (influencerId === void 0) { influencerId = null; }
        if (influencerId === null)
            return null;
        var influencer = this.influencers.find(function (influencer) { return influencer.id === influencerId; });
     ...
     */
    FieldService.prototype.getInfluencer = function (influencerId) {
        var _this = this;
        if (influencerId === void 0) { influencerId = null; }
        return new Promise(function (resolve) {
            setTimeout(function () {
                var influencer = _this.getInfluencerSync(influencerId);
                var clonedInfluencer = influencer ? new Influencer_1["default"](influencer) : null;
